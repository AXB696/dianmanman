...
.section-title--busy { color: #ff4d4f; }
.section-title--idle { color: #52c41a; }
...
.clickable:hover { background: rgba(22, 119, 255, 0.04) !important; }
...
.detail-close { font-size: 14px; color: #9ca3af; cursor: pointer; }
.detail-close:hover { color: #ff4d4f; }
...
.detail-tag { font-size: 10px; padding: 2px 8px; border-radius: 10px; background: #e6f4ff; color: #1677ff; }
.detail-tag--type { background: #e6fffb; color: #13c2c2; }
.detail-tag--rating { background: #fffbe6; color: #faad14; }
.detail-avail { margin-bottom: 12px; }
.detail-avail-header { display: flex; justify-content: space-between; font-size: 11px; color: var(--text-secondary); margin-bottom: 4px; }
.detail-avail-bar { height: 6px; background: #f3f4f6; border-radius: 3px; overflow: hidden; margin-bottom: 4px; }
.detail-avail-fill { height: 100%; border-radius: 3px; transition: width 0.6s ease; }
.detail-avail-stats { display: flex; justify-content: space-between; font-size: 10px; color: var(--text-secondary); }
