...
.period-btn:hover { color: var(--text-accent); }
.period-btn.active {
  background: var(--color-primary); color: #070c14; font-weight: 600;
}
...
.order-label { font-size: 12px; color: var(--text-dim); line-height: 1.4; }
...
.order-divider { width: 1px; height: 32px; background: var(--border-subtle); flex-shrink: 0; }
</style>
